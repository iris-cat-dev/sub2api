...
func init() {
	...
	// userDescDiscountMultiplier is the schema descriptor for discount_multiplier field.
	userDescDiscountMultiplier := userFields[5].Descriptor()
	// user.DefaultDiscountMultiplier holds the default value on creation for the discount_multiplier field.
	user.DefaultDiscountMultiplier = userDescDiscountMultiplier.Default.(float64)
