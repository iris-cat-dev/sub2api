export default {
    ...
    groups: {
      ...
      videoPricing: {
        ...
        description:
          'Configure platform Grok video generation prices in CNY per second of output video. Leave empty to use the default per-second values (grok-imagine-video: ¥0.05/s 480p, ¥0.07/s 720p; video-1.5: ¥0.08/s 480p, ¥0.14/s 720p, ¥0.25/s 1080p).',
      ...
      webSearchPricing: {
        ...
        pricePerCallHint:
          'Leave empty to use the default ¥0.01 per call (platform display: ¥10 per 1,000 calls); 0 means free. The group rate multiplier is applied on top.',
