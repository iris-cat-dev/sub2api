export default {
    ...
    groupModelPricing: {
      ...
      addRow: 'Add Pricing Row',
      syncWhitelist: 'Sync Whitelist',
      syncingWhitelist: 'Syncing...',
      noWhitelistModels: 'This group has no model whitelist to sync',
      whitelistAlreadySynced: 'All whitelisted models are already in the pricing list',
      whitelistSynced: 'Imported {count} models from the whitelist. Review and save each row',
      longContextEnabled: 'Long-context pricing is enabled.',
      longContextDisabled: 'Long-context pricing is disabled.',
      longContextHint: 'This status follows the group setting; each pricing row is saved independently here.',
      loading: 'Loading model pricing...',
      loadingShort: 'Loading...',
      empty: 'No model pricing yet. Add a pricing row to get started.',
      models: 'Models',
      modelsPlaceholder: 'One model per line or comma-separated',
      modelsHint: 'Official pricing uses the first model',
      billingMode: 'Billing Mode',
      multiplier: 'Official Price Multiplier',
      prices: 'Price Configuration',
      multiplierHint: 'Changing it immediately fills prices that have official values',
      multiplierInvalid: 'Multiplier must be greater than 0',
      official: 'Official',
      officialLoadFailed: 'Load failed',
      ...
      saving: 'Saving...',
      delete: 'Delete',
      saveSuccess: 'Model pricing row saved',
      saveFailed: 'Failed to save model pricing row',
      deleteSuccess: 'Model pricing row deleted',
      deleteFailed: 'Failed to delete model pricing row',
      loadFailed: 'Failed to load group model pricing'
    },
