export default {
    ...
    groupModelPricing: {
      ...
      addRow: '添加价格行',
      syncWhitelist: '同步白名单',
      syncingWhitelist: '正在同步...',
      noWhitelistModels: '当前分组没有可同步的模型白名单',
      whitelistAlreadySynced: '白名单中的模型均已在价格列表中',
      whitelistSynced: '已从白名单导入 {count} 个模型，请逐行确认并保存',
      longContextEnabled: '长上下文计费已启用。',
      longContextDisabled: '长上下文计费未启用。',
      longContextHint: '此状态沿用分组配置；价格行在此页面独立保存。',
      loading: '正在加载模型价格...',
      loadingShort: '加载中...',
      empty: '暂无模型价格，点击“添加价格行”开始配置。',
      models: '模型',
      modelsPlaceholder: '每行或逗号分隔一个模型',
      modelsHint: '官方价格按第一个模型加载',
      billingMode: '计费模式',
      multiplier: '官方价格倍率',
      prices: '价格配置',
      multiplierHint: '修改后立即填充有官方值的价格',
      multiplierInvalid: '倍率必须大于 0',
      official: '官方',
      officialLoadFailed: '加载失败',
      noOfficialPrice: '无官方价格',
      inputPrice: '输入',
      outputPrice: '输出',
      cacheWrite5m: '缓存写 5m',
      cacheWrite1h: '缓存写 1h',
      ...
      saving: '保存中...',
      delete: '删除',
      saveSuccess: '模型价格行已保存',
      saveFailed: '保存模型价格行失败',
      deleteSuccess: '模型价格行已删除',
      deleteFailed: '删除模型价格行失败',
      loadFailed: '加载分组模型价格失败'
    },
